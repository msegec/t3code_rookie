...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.previewGatewayIssue]: AuthOrchestrationOperateScope,
  [WS_METHODS.previewGatewayRegister]: AuthOrchestrationOperateScope,
  [WS_METHODS.previewGatewayRevoke]: AuthOrchestrationOperateScope,
