...
export class ProjectUploadTargetExistsError extends Schema.TaggedError<ProjectUploadTargetExistsError>()(
...
export class ProjectCreateUploadUrlError extends Schema.TaggedError<ProjectCreateUploadUrlError>()(
...
export class ProjectRenameEntryTargetExistsError extends Schema.TaggedError<ProjectRenameEntryTargetExistsError>()(
